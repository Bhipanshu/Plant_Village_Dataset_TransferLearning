...
class CustomGoogleNet(nn.Module):
    def __init__(self, num_classes=15):
        ...
        try:
            import os
            os.remove(torch.hub.get_dir() + '/checkpoints/googlenet.pth')
...
best_model_filename = 'googlenet_individual_15classes.pth'
...
model = CustomGoogleNet(num_classes=15)

model_path = 'googlenet_individual_15classes.pth'
