...
criterion.to(device)
optimizer = optim.SGD(model.googlenet.fc.parameters(), lr=0.001, momentum=0.9)
...
best_model_filename = 'googlenet-38classes.pth'
torch.save(best_model_state, best_model_filename)
print(f'Total training time in minnutes: {total_training_time_minutes: .2f}')
...
model = CustomGoogleNet(num_classes=38)


model_path = 'googlenet-38classes.pth'
...
print(f'Total params: {total_params: .2f} params(M)')
